...
let emoji1 = { x: 100, y: 100, s: 0.4 };
let emoji2 = { x: 400, y: 200, s: 0.6 };
let emoji3 = { x: 200, y: 350, s: 0.5 };

function draw() {
  clear();
  emojiBear(emoji1.x, emoji1.y, emoji1.s);
  emojiBear(emoji2.x, emoji2.y, emoji2.s);
  emojiBear(emoji3.x, emoji3.y, emoji3.s);
}
